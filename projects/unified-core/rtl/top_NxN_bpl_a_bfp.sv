...
//   variant built on the bit-plane column dispatch and PE (disp_array_b_bpl_a_bfp,
//   pe_bpl_a_bfp). Tiles N*N cores; operand A (mantissa + exponent) is shared per
