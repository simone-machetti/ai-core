...
//   also produces the operands dp_8_bpl_a_bfp needs. Routing is unchanged from
...
//
//   What is added is one gate_n_bpl_bfp per DP8, downstream of the gate, which
