...
# -----------------------------------------------------------------------------
make syn PROJECT=unified-core TOP_LEVEL=pe OUT_DIR=pe_hier_syn \
    KEEP_MODULES="pe_array acc_array dp_8"

make syn PROJECT=unified-core TOP_LEVEL=pe_sqr OUT_DIR=pe_sqr_hier_syn \
    KEEP_MODULES="pe_array_sqr acc_array_sqr dp_8_sqr"

make syn PROJECT=unified-core TOP_LEVEL=pe_bfp OUT_DIR=pe_bfp_hier_syn \
...
make syn PROJECT=unified-core TOP_LEVEL=dp_8_bpl_b_bfp OUT_DIR=dp_8_bpl_b_bfp_syn
...
make syn PROJECT=unified-core TOP_LEVEL=pe_bpl_b_bfp OUT_DIR=pe_bpl_b_bfp_hier_syn \
