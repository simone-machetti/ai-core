...
# -----------------------------------------------------------------------------
make syn PROJECT=unified-core TOP_LEVEL=pe OUT_DIR=pe_syn CLK_PERIOD_NS=$CLK \
...
# -----------------------------------------------------------------------------
make pnr PROJECT=unified-core TOP_LEVEL=pe OUT_DIR=pe_pnr NETLIST_DIR=pe_syn CLK_PERIOD_NS=$CLK \
...
# -----------------------------------------------------------------------------
make syn PROJECT=unified-core TOP_LEVEL=top_NxN OUT_DIR=top_2x2_syn CLK_PERIOD_NS=$CLK \
...
# -----------------------------------------------------------------------------
make pnr PROJECT=unified-core TOP_LEVEL=top_NxN OUT_DIR=top_2x2_pnr NETLIST_DIR=top_2x2_syn CLK_PERIOD_NS=$CLK \
    ...
    FLOORPLAN=projects/unified-core/scripts/floorplan_top_NxN.tcl MACRO_CHANNEL=40 PDN=none \
    DROUTE_END_ITER=0
