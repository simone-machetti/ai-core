...
| Component                                                                                               | Baseline | Square | Baseline-BFP | Square-BFP     | ×count  |
| ------------------------------------------------------------------------------------------------------- | -------- | ------ | ------------ | -------------- | ------- |
| [ctrl](../modules/ctrl.md) / [ctrl_sqr](../modules/ctrl_sqr.md)                                         | ✓        | ✓      | ✓ (`ctrl`)   | ✓ (`ctrl_sqr`) | 1       |
...
| -------------------- | -------- | -------- | ------------ | ---------- |
| `ctrl` / `ctrl_sqr`  | 8.879    | 9.769    | 8.879        | 9.769      |
| `const`              | —        | 3.747    | —            | 4.184      |
| `disp_array_a`       | 277.734  | 366.118  | 277.734      | 366.118    |
| `disp_array_b`       | 466.327  | 332.686  | 466.327      | 332.686    |
| `disp_array_exp_a`   | —        | —        | 42.924       | 41.990     |
| `disp_array_exp_b`   | —        | —        | 75.174       | 68.584     |
| `pe_array_alpha`     | —        | 1962.235 | —            | 1226.688   |
| `pe_array_beta`      | —        | 1753.682 | —            | 1070.755   |
| `pe` (per variant)   | 3816.519 | 3320.303 | 5345.990     | 5204.929   |
| `icg`                | 0.262    | 0.262    | 0.262        | 0.262      |

Grid totals, µm²:

| Grid  | Baseline  | Square    | Baseline-BFP | Square-BFP | Square/Base | Sqr-BFP/Base-BFP |
| ----- | --------- | --------- | ------------ | ---------- | ----------- | ---------------- |
| 8×8   | 250241.32 | 247872.02 | 349072.25    | 358008.41  | −0.9 %      | **+2.6 %**       |
| 16×16 | 989019.95 | 920742.46 | 1382454.10   | 1382263.84 | −6.9 %      | **−0.0 %**       |
