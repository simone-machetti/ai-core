# PE Array (Bit-Plane BFP)

`pe_array_bpl_bfp` — the bit-plane build of [pe_array_bfp](./pe_array_bfp.md): the same 4-level crossed carry-save reduction tree, the same 11 in-tree [align_cell_bfp](./align_cell_bfp.md) sites and the same exponent max-tree, with the 16 DP8 leaves swapped from [dp_8](./dp_8.md) to [dp_8_bpl_bfp](./dp_8_bpl_bfp.md).
...
```systemverilog
pe_array_bpl_bfp pe_array_bpl_bfp_i (
...
Source: [pe_array_bpl_bfp.sv](../../rtl/pe_array_bpl_bfp.sv) — Testbench: [tb_pe_array_bpl_bfp.sv](../../tb/tb_pe_array_bpl_bfp.sv) — Diagram: [pe_array_bpl_bfp](../../doc/diagrams/pe_array_bpl_bfp.excalidraw)
