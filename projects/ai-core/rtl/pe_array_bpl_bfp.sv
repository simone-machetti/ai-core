...
//   DP8 cores are dp_8_bpl_bfp. Same 4-level crossed carry-save reduction tree,
...
//   disp_array_b_bpl_bfp; and is_signed_b_i is gone, since B's signedness is
