...
//
// Description:
//   Parameterized bit-plane conditioning gate for operand B. Takes SIZE input
//   words, WIDTH bits wide, sharing one runtime signedness flag, and produces
//   the two operand sets a bit-plane dot product needs:
...
//   per-column dispatch (disp_array_b_bpl_bfp) and its cost is amortized over
...
//   values is what lets dp_8_bpl_bfp drop its is_signed_b_i port entirely.
//   Combinational.
//
// Parameters:
