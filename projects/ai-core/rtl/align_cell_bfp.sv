...
//   fill extension), the other bundle passes through bit-identical, and row
//   positions are preserved (out_0_o aligns with in_0_i). On equal exponents
...
module align_cell_bfp #(
    ...
    output logic [    WIDTH-1:0] out_0_o   [0:SIZE_0-1],
    output logic [    WIDTH-1:0] out_1_o   [0:SIZE_1-1],
