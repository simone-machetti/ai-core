...
#
# Description:
#   Stacked-bar chart of synthesized cell area at the PE level for the four PE
#   variants - baseline (pe), square (pe_sqr), BFP (pe_bfp) and square-BFP
#   (pe_sqr_bfp) - split into DP8-Array / CPR-Tree / ACC-Array / PE glue. The
#   composition comes from runs with the internal module boundaries preserved
#   (imp/{pe,pe_sqr,pe_bfp,pe_sqr_bfp}_hier_syn, produced by
